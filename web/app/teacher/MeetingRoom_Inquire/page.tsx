...
export default function App() {
    ...
    const handleSearch = () => {
        if (process.env.NEXT_PUBLIC_TEST === "test") {
            ...
            try {
                API.TeacherServiceApi.getMeetingRoom({
                    Keywords: {
                        MRno: mrno,
                    }
                })
    ...
    const handleSearch2 = () => {
        if (process.env.NEXT_PUBLIC_TEST === "test") {
            setMeetingRooms2([
                ...
                {
                    MRno: "3",
                    Uno: ['21122811', '21122811', '211228', '6756', '21122812', '21122812', 'empty', 'empty', '21122813', '21122813', 'empty', 'empty'],
                },
                {
                    MRno: "4",
                    Uno: ['21122811', '21122811', 'empty', 'empty', '21122812', '21122812', 'empty', 'empty', '21122813', '21122813', 'empty', 'empty'],
            ...
            try {
                if (userInfo)
                    API.TeacherServiceApi.getMyMeetingRoom({
                        Keywords: {
                            Uno: userInfo.userId,
                        }
                    })
        ...
        if (process.env.NEXT_PUBLIC_TEST === "test") {
            ...
            try {
                if (userInfo) {
                    ...
                    API.TeacherServiceApi.postMeetingRoom({
                        Info: {
                            MRno: MRno,
                            MRtime: MRTimeArray,
                            Uno: UnoArray,
    ...
    const handleCancel = (MRno: string) => {
        ...
        if (process.env.NEXT_PUBLIC_TEST === "test") {
            ...
            try {
                if (userInfo) {
                    API.TeacherServiceApi.cancelMeetingRoom({
                        Key: {
                            MRno: MRno,
                            Uno: userInfo.userId,
                        }
