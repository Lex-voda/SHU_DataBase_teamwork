...
export default function MyTableRow2({ item, handleDate, handleCancel }: { item: MeetingRoomType; handleDate: (MRno: string, MRTimeArray: string[]) => void; handleCancel: (MRno: string) => void }) {
